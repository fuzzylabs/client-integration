...
namespace GoogleCloudSamples
{
    ...
    {
        private static readonly string s_projectId = "project-id";
        ...
        private static readonly string s_usage =
                ...
                "  QuickStart <path-to-credentials> upload bucket-name local-file-path [object-name]\n";
        ...
        public Google.Apis.Auth.OAuth2.GoogleCredential CreateStorageClient(string pathToCredentials = "")
        {
        ...
        class UploadProgressReporter : IProgress<IUploadProgress>
        {
            private long fileSize;
            public UploadProgressReporter(long uploadingFileSize)
            {
            ...
            {
                Console.WriteLine($"{value.Status.ToString()} {value.BytesSent / 1024 / 1024} / {fileSize / 1024 / 1024} Mb");
            }
        }
            ...
            try
            {
                switch (args[0].ToLower())
                {
                    ...
                    case "upload":
                        ...
                        UploadFile(args[1], args[2], args[3], args.Length < 5 ? null : args[4]);
                        break;
